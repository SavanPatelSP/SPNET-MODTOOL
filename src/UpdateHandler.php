...
class UpdateHandler
{
    ...
    private function guideTextParts(): array
    {
        ...
        $parts[] = implode("\n", [
            '<b>SP NET MOD TOOL – Usage Guide (1/8)</b>',
        ...
        $parts[] = implode("\n", [
            '<b>Usage Guide (2/8) – Chats + Identity</b>',
            '<b>List & Pick Chats</b>',
            '<code>/mychats</code> (list chats + ids)',
            '<code>/usechat -1001234567890</code>',
            '<code>/usechat My Group Title</code>',
            '<code>/usechat off</code>',
            '<code>/linkedchat</code> (show default chat)',
            '',
            '<b>Identity + Access</b>',
            '<code>/whoami</code>',
            '<code>/botusers 30 20</code> (who used bot in last 30 days)',
            '',
            '<b>Settings</b>',
            '<code>/setbudget 300</code>',
            '<code>/settimezone Asia/Kolkata</code>',
            '<code>/setactivity 5 1</code> (gap + floor)',
        ]);

        $parts[] = implode("\n", [
            '<b>Usage Guide (3/8) – Mod Management</b>',
            '<b>Add / Remove Mods</b>',
            ...
            '',
            '<b>Mod Audit</b>',
            '<code>/modaudit 25</code> (recent changes)',
        ]);

        $parts[] = implode("\n", [
            '<b>Usage Guide (4/8) – Roster + Goals</b>',
            '<b>Roster</b>',
            '<code>/rosteradd @alex lead "evening shift"</code>',
            '<code>/rosterrole @alex lead "senior"</code>',
            '<code>/rosterremove @alex</code>',
            '<code>/rosterlist</code>',
            '',
            '<b>Personal Dashboard + Goals</b>',
            '<code>/mydashboard</code>',
            '<code>/goalset messages 500</code>',
            '<code>/goalset active_hours 12</code>',
            '<code>/goalset actions 30</code>',
            '<code>/goalstatus</code>',
            '<code>/goalclear</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Usage Guide (5/8) – Stats & Hours</b>',
            '<b>Stats</b>',
            '<code>/stats</code>',
            '<code>/stats 2026-02</code>',
            '<code>/stats @alex</code>',
            '<code>/stats -1001234567890 2026-02 @alex</code>',
            '',
            '<b>Timesheet + Compare</b>',
            '<code>/timesheet @alex 2026-02-01 2026-02-28</code>',
            '<code>/compare @alex @maria 2026-02</code>',
            '',
            '<b>Activity Rank + Hours</b>',
        ...
        $parts[] = implode("\n", [
            '<b>Usage Guide (6/8) – Rewards & Reports</b>',
            '<b>Leaderboards</b>',
            ...
            '<code>/summary 2026-02 1200</code> (multi-chat)',
            '',
            '<b>Forecasts + Progress</b>',
            '<code>/forecast 300</code>',
            '<code>/progress 300</code>',
            '<code>/weeklysummary 7</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Usage Guide (7/8) – AI Insights</b>',
            '<b>Coaching + Health</b>',
            ...
            '<code>/trend 2026-02 300</code>',
            '<code>/execsummary 2026-02 300</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Usage Guide (8/8) – Automation + Admin</b>',
            '<b>Automation</b>',
            '<code>/autoreport on 1 9</code>',
            '<code>/autoprogress on 15 12</code>',
            '<code>/autoweekly on 1 10</code>',
            '<code>/autoinactive on 7 10</code>',
            '<code>/autospike on 10 35%</code>',
            '<code>/autoaireview on 1 9</code>',
            '<code>/autoretention on 2 10 30%</code>',
            '<code>/autofeedback on 20</code>',
            '',
            '<b>Plans + Approvals</b>',
            '<code>/plan</code>',
            '<code>/setplan premium 30</code>',
            '<code>/giftplan -1001234567890 premium 30</code>',
            '<code>/grantplan -1001234567890 enterprise 30</code>',
