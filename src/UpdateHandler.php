...
class UpdateHandler
{
    ...
    private function guideTextParts(): array
    {
        ...
        $parts[] = implode("\n", [
            '<b>SP NET MOD TOOL – Usage Guide (1/5)</b>',
            ...
            '<code>/help</code> · <code>/guide</code>',
            '',
            '<b>Account</b>',
            '<code>/whoami</code>',
            '<code>/linkedchat</code>',
            '<code>/mychats</code>',
            '<code>/usechat &lt;chat_id&gt;</code> | <code>/usechat &lt;title&gt;</code> | <code>/usechat off</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Usage Guide (2/5) – Core Stats</b>',
            '<b>Stats & Search</b>',
            '<code>/stats</code>',
        ...
        $parts[] = implode("\n", [
            '<b>Usage Guide (3/5) – Rewards & Reports</b>',
            '<b>Reward Sheets</b>',
            ...
            '',
            '<b>Forecasts</b>',
            '<code>/forecast 300</code> (current month)',
            '<code>/progress 300</code> (mid-month report)',
            '<code>/weeklysummary 7</code> (manual)',
            '',
            '<b>AI Insights</b>',
        ...
        $parts[] = implode("\n", [
            '<b>Usage Guide (4/5) – Automation</b>',
            '<b>Auto Reports</b>',
        ...
        $parts[] = implode("\n", [
            '<b>Usage Guide (5/5) – Admin + Extras</b>',
            '<b>Mod Management</b>',
            ...
            '<code>/setactivity 5 1</code>',
            '',
            '<b>Plans + Approvals</b>',
            '<code>/plan</code>',
            '<code>/setplan premium 30</code> (owner only)',
