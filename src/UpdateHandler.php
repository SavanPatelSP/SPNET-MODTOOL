...
class UpdateHandler
{
    ...
    private function guideTextParts(): array
    {
        ...
        $parts[] = implode("\n", [
            '<b>SP NET MOD TOOL – Full Guide (1/10)</b>',
            'All commands are used in <b>private chat</b>.',
            'Reports go to the <b>reports channel</b> and managers.',
            '',
            '<b>Quick Start</b>',
            '1) Add bot to group as admin (or disable privacy mode).',
            '2) Send any message in the group.',
            '3) In private: <code>/mychats</code> → <code>/usechat &lt;chat_id&gt;</code>',
            '4) Add mods: <code>/modadd @alex</code>',
            '',
            '<b>/menu</b> – status + next steps',
            'Example: <code>/menu</code>',
            '<b>/help</b> – short help list',
            'Example: <code>/help</code>',
            '<b>/guide</b> – full guide with examples',
            'Example: <code>/guide</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Guide (2/10) – Chats + Identity</b>',
            '<b>/mychats</b> – list your chats + ids',
            'Example: <code>/mychats</code>',
            '<b>/usechat</b> – set default chat',
            'Examples: <code>/usechat -1001234567890</code> · <code>/usechat My Group</code> · <code>/usechat off</code>',
            '<b>/linkedchat</b> – show current default chat',
            'Example: <code>/linkedchat</code>',
            '<b>/whoami</b> – show your role + user id',
            'Example: <code>/whoami</code>',
            '<b>/botusers</b> – who used bot recently',
            'Example: <code>/botusers 30 20</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Guide (3/10) – Mod Management</b>',
            '<b>/modadd</b> – add a mod',
            'Examples: <code>/modadd @alex</code> · <code>/modadd 123456789</code>',
            '<b>/modremove</b> – remove a mod',
            'Example: <code>/modremove @alex</code>',
            '<b>/modlist</b> – list all mods',
            'Example: <code>/modlist</code>',
            '<b>/modaudit</b> – recent mod changes',
            'Example: <code>/modaudit 25</code>',
            '<b>/finduser</b> – search by name/username/id',
            'Examples: <code>/finduser alex</code> · <code>/finduser @alex</code> · <code>/finduser 123456789</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Guide (4/10) – Roster + Roles</b>',
            '<b>/rosteradd</b> – add roster role + notes',
            'Example: <code>/rosteradd @alex lead "evening shift"</code>',
            '<b>/rosterrole</b> – update role + notes',
            'Example: <code>/rosterrole @alex lead "senior"</code>',
            '<b>/rosterremove</b> – remove from roster',
            'Example: <code>/rosterremove @alex</code>',
            '<b>/rosterlist</b> – list roster',
            'Example: <code>/rosterlist</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Guide (5/10) – Personal Goals</b>',
            '<b>/mydashboard</b> – your mod stats + badges',
            'Example: <code>/mydashboard</code>',
            '<b>/goalset</b> – set monthly goal',
            'Examples: <code>/goalset messages 500</code> · <code>/goalset active_hours 12</code>',
            '<b>/goalstatus</b> – view goal progress',
            'Example: <code>/goalstatus</code>',
            '<b>/goalclear</b> – clear your goals',
            'Example: <code>/goalclear</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Guide (6/10) – Stats + Hours</b>',
            '<b>/stats</b> – mod stats',
            'Examples: <code>/stats</code> · <code>/stats 2026-02</code> · <code>/stats @alex</code>',
            '<b>/timesheet</b> – CSV of activity hours',
            'Example: <code>/timesheet @alex 2026-02-01 2026-02-28</code>',
            '<b>/compare</b> – compare two mods',
            'Example: <code>/compare @alex @maria 2026-02</code>',
            '<b>/activityrank</b> – ranking by activity type',
            'Example: <code>/activityrank 2026-02 5</code>',
            '<b>/debughours</b> – raw active/presence minutes',
            'Example: <code>/debughours 2026-02 @alex</code>',
            '<b>/debughoursall</b> – raw minutes for all mods',
            'Example: <code>/debughoursall 2026-02</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Guide (7/10) – Rewards + Reports</b>',
            '<b>/leaderboard</b> – ranking + rewards',
            'Example: <code>/leaderboard 2026-02 300</code>',
            '<b>/report</b> – reward sheet (HTML)',
            'Example: <code>/report 2026-02 300</code>',
            '<b>/reportcsv</b> – reward sheet (CSV)',
            'Example: <code>/reportcsv 2026-02 300</code>',
            '<b>/exportgsheet</b> – export to Google Sheets',
            'Example: <code>/exportgsheet 2026-02 300</code>',
            '<b>/summary</b> – multi-chat summary',
            'Example: <code>/summary 2026-02 1200</code>',
            '<b>/forecast</b> – reward forecast (MTD)',
            'Example: <code>/forecast 300</code>',
            '<b>/progress</b> – mid-month progress report',
            'Example: <code>/progress 300</code>',
            '<b>/weeklysummary</b> – manual weekly report',
            'Example: <code>/weeklysummary 7</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Guide (8/10) – AI Insights</b>',
            '<b>/coach</b> – coaching summary',
            'Example: <code>/coach 2026-02</code>',
            '<b>/health</b> – team health score',
            'Example: <code>/health 2026-02</code>',
            '<b>/aireview</b> – AI performance review',
            'Example: <code>/aireview 2026-02</code>',
            '<b>/retention</b> – retention risk alerts',
            'Example: <code>/retention 2026-02 30%</code>',
            '<b>/trend</b> – trend report',
            'Example: <code>/trend 2026-02 300</code>',
            '<b>/execsummary</b> – executive summary',
            'Example: <code>/execsummary 2026-02 300</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Guide (9/10) – Automation</b>',
            '<b>/autoreport</b> – monthly report schedule',
            'Example: <code>/autoreport on 1 9</code>',
            '<b>/autoprogress</b> – mid-month schedule',
            'Example: <code>/autoprogress on 15 12</code>',
            '<b>/autoweekly</b> – weekly schedule',
            'Example: <code>/autoweekly on 1 10</code>',
            '<b>/autoinactive</b> – inactivity alerts',
            'Example: <code>/autoinactive on 7 10</code>',
            '<b>/autospike</b> – activity drop alerts',
            'Example: <code>/autospike on 10 35%</code>',
            '<b>/autoaireview</b> – monthly AI review',
            'Example: <code>/autoaireview on 1 9</code>',
            '<b>/autoretention</b> – retention alerts',
            'Example: <code>/autoretention on 2 10 30%</code>',
            '<b>/autofeedback</b> – daily tips',
            'Example: <code>/autofeedback on 20</code>',
        ]);

        $parts[] = implode("\n", [
            '<b>Guide (10/10) – Plans + Admin</b>',
            '<b>/plan</b> – current plan',
            'Example: <code>/plan</code>',
            '<b>/setplan</b> – set plan (owner)',
            'Example: <code>/setplan premium 30</code>',
            '<b>/giftplan</b> – gift plan (manager/owner)',
            'Example: <code>/giftplan -1001234567890 premium 30</code>',
            '<b>/grantplan</b> – grant plan (manager/owner)',
            'Example: <code>/grantplan -1001234567890 enterprise 30</code>',
            '<b>/approval</b> – require report approval',
            'Example: <code>/approval on</code>',
            '<b>/approvereport</b> – approve report',
            'Example: <code>/approvereport 2026-02</code>',
            '<b>/approvalstatus</b> – check approval',
            'Example: <code>/approvalstatus 2026-02</code>',
            '<b>/premium</b> / <b>/benefits</b> – premium benefits',
            'Example: <code>/premium</code>',
            '<b>/pricing</b> – pricing tiers',
            'Example: <code>/pricing</code>',
            '<b>/auditlogcsv</b> – export audit log',
            'Example: <code>/auditlogcsv 200</code>',
            '<b>/buy_stars_test</b> – test Stars',
            'Example: <code>/buy_stars_test 500</code>',
            '<b>/buy_crypto_test</b> – test crypto checkout',
            'Example: <code>/buy_crypto_test 25</code>',
            '<b>/paystatus</b> – latest payment',
            'Example: <code>/paystatus</code>',
            '<b>/archive</b> – archive current chat data',
            'Example: <code>/archive</code>',
            '',
            '<b>Dashboard Links</b>',
            ...
            '',
            '<b>Support</b>',
            'If bot is silent: check DNS/network and api.telegram.org access.',
        ]);
